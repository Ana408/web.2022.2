    ...
    return (
        <div style={{marginTop:20}}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='form-group'>
                    <label>Curso:</label>
                    <input type="text" className='form-control' placeholder='Digite seu curso'
                        onChange={
                            (event)=>{
                ...
                <div className='form-group'>
                    <label>Salário:</label>
                    <input type="number"step='any' className='form-control' placeholder='Digite seu salário' onChange={
                            (event)=>{
